...
public class ClaimedChunkData {
    ...
    public ClaimedChunkData(
                            int x, int z, int dim, UUID ownerUUID, String ownerName, String partyName,
    ...
    public static ClaimedChunkData fromNBT(NBTTagCompound tag) {
        ...
        // Missing "dim" key means data predates dimension support; default to overworld (0).
        ...
        return new ClaimedChunkData(x, z, dim, owner, name, team, force);
    }
}
