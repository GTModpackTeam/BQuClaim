 ...
 */
public class MessageClientNotify implements IMessage {
    ...
    public MessageClientNotify() {}

    public static MessageClientNotify chunkTransit(String playerName, RelationType relation, boolean entered) {
        var msg = new MessageClientNotify();
    ...
    public static MessageClientNotify partyEvent(String eventType, String playerName, String extraInfo) {
        var msg = new MessageClientNotify();
    ...
    public static MessageClientNotify claimFailed(String reason, int current, int max) {
        var msg = new MessageClientNotify();
