package com.github.gtexpert.teamclaim.module;
...
import com.github.gtexpert.teamclaim.api.modules.*;
...
public class ModuleManager implements IModuleManager {
    ...
    private final Logger logger = LogManager.getLogger("TeamClaimMod Module Loader");
    ...
    private void configureModules(Map<String, List<IModule>> modules) {
        ...
        config.addCustomCategoryComment(MODULE_CFG_CATEGORY_NAME,
                "Module configuration file. Can individually enable/disable modules from TeamClaimMod");
